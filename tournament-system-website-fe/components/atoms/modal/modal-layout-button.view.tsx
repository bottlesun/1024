...
import ModalBottomView, { ModalBottomProps } from "./modal-bottom.view";
...
const ModalLayoutButtonView = ({ ...props }: ModalLayoutProps) => {
    ...
    <div>
      <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        <Box css={ModalWrap}>
          ...
          <ModalBottomView {...props?.ModalBottomProps} />
        </Box>
      </Modal>
    </div>
  );
...
export default ModalLayoutButtonView;
